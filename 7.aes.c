...
void aes_encrypt(unsigned char *plaintext, unsigned char *ciphertext) //Encrypt message
{
    AES_KEY key;
...
void aes_decrypt(unsigned char *ciphertext, unsigned char *decryptedtext) //Decrypt message
{
    AES_KEY key;
